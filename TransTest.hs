...
testTwoAndGates = do
  ...
  where
    ...
    expected = [AndCausality (rise a, rise out), AndCausality (rise b, rise out), AndCausality (rise c, rise out), AndCausality (rise d, rise out),
                OrCausality ([fall a, fall b], fall out), OrCausality ([fall c, fall d], fall out)]
